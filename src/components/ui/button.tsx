...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-emerald-500 to-cyan-500 text-white shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 hover:from-emerald-400 hover:to-cyan-400 focus-visible:ring-emerald-500",
        destructive:
        ...
        outline:
          "border-2 border-zinc-700 bg-zinc-900/50 backdrop-blur-sm hover:bg-zinc-800 hover:border-zinc-600 text-zinc-200 focus-visible:ring-zinc-400",
        secondary:
          "bg-zinc-800 text-zinc-100 hover:bg-zinc-700 focus-visible:ring-zinc-400",
        ghost:
          "hover:bg-zinc-800 hover:text-zinc-100 text-zinc-400 focus-visible:ring-zinc-400",
        link: "text-emerald-400 underline-offset-4 hover:underline focus-visible:ring-emerald-500",
        success:
          "bg-gradient-to-r from-emerald-600 to-green-600 text-white shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 hover:from-emerald-500 hover:to-green-500 focus-visible:ring-emerald-500",
      },
      size: {
